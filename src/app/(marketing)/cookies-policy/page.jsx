                ...
                <div className="relative z-10">
                  ...
                  <div className="p-6 bg-white border border-gray-100 rounded-2xl flex gap-4 mt-12 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm mt-1">This policy runs parallel to our broader Privacy & Security protocols.</p>
                    </div>
                  </div>
                </div>
              </motion.section>
