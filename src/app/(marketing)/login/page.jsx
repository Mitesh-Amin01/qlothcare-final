...
import { ArrowRight, Eye, EyeOff, Sparkles, Chrome, Command, ShieldCheck, Mail, Lock } from 'lucide-react';
   ...
   return (
      <div className="min-h-screen w-full flex bg-[#050505] text-white font-sans overflow-hidden">
               ...
               >
                  ...
                  <div className="flex items-center gap-5">
                     <div className="relative w-14 h-14 rounded-full border border-white/20 p-1">
                        <div className="w-full h-full rounded-full bg-clothcare-primary/20 flex items-center justify-center font-bold text-lg">RM</div>
                        <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#050505] rounded-full flex items-center justify-center">
                           <ShieldCheck size={12} className="text-green-400" />
                        </div>
                     </div>
                     <div>
                        <p className="font-bold text-white text-lg tracking-wide">Rahul Mehta</p>
                        <p className="text-sm text-white/40 uppercase tracking-widest font-bold mt-1">Member Since 2025</p>
                     </div>
                  </div>
               </motion.div>
            </div>
         ...
         {/* ==========================================
                ...
                ========================================== */}
         <div className="w-full lg:w-7/12 flex items-center justify-center p-6 lg:p-20 relative bg-[#050505] z-10">
            ...
            <div className="w-full max-w-[480px] relative z-20">
               ...
               >
                  <div className="mb-4">
                     <span className="text-clothcare-primary font-bold uppercase tracking-[0.2em] text-xs pb-4 block">Secure Terminal</span>
                  ...
                  {/* Social Login Trio */}
                  <div className="grid grid-cols-2 gap-4 my-10 border-b border-white/10 pb-10">
                  ...
                  {/* Footer Links */}
                  <div className="mt-12 text-center text-sm font-medium text-white/40 pt-10 border-t border-white/5">
                     <p className="mb-4">
