                ...
                <div className="relative z-10">
                  ...
                  <div className="p-6 bg-white border border-gray-100 rounded-2xl flex gap-4 mt-12 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm mt-1">We reserve the right to amend these terms dynamically. Continued use implies acceptance of the updated protocols.</p>
                    </div>
                  </div>
                </div>
              </motion.section>
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-clothcare-primary/20 transition-all duration-500 group flex gap-6">
                      <div className="w-12 h-12 shrink-0 bg-[#FAFAFA] rounded-2xl flex items-center justify-center text-clothcare-dark group-hover:bg-clothcare-primary/10 group-hover:text-clothcare-primary transition-colors">
                        <CheckCircle2 />
                      </div>
                      <div>
                        <h4 className="text-xl font-bold text-clothcare-dark mb-3 tracking-tight">User Responsibility</h4>
                        <p className="text-gray-500 leading-relaxed font-medium">Users must ensure accurate scheduling. We request clients to verify pockets are empty prior to handover. We reserve the right to audit items for safety and fabric integrity before processing.</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-clothcare-dark/20 transition-all duration-500 group flex gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 leading-relaxed font-medium">Dynamic pricing may apply based on extreme fabric complexity, bio-hazard removal, and expedited turnaround speeds. All final fees will be transparently disclosed before processing begins.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <motion.section id="liability" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="bg-[#18181B] text-white p-10 lg:p-14 rounded-3xl relative overflow-hidden shadow-2xl">
                    ...
                    <ShieldAlert className="text-clothcare-primary mb-8" size={48} strokeWidth={1} />
                    <h3 className="text-3xl font-display font-bold mb-8">Risk & Reimbursement.</h3>

                    <div className="grid md:grid-cols-2 gap-8 relative z-10">
                      <div className="space-y-4">
                        <h4 className="text-clothcare-primary font-black text-sm uppercase tracking-widest">Limited Liability</h4>
                      ...
                      <div className="space-y-4">
                        <h4 className="text-clothcare-primary font-black text-sm uppercase tracking-widest">Insurance Coverage</h4>
                        <p className="text-gray-400 leading-relaxed">
                  ...
                  <div className="p-8 bg-white border-2 border-clothcare-dark rounded-3xl">
                    <div className="flex gap-6 items-center">
                      ...
                      <p className="text-lg text-clothcare-dark font-medium leading-relaxed">
                        These operational terms and all ensuing agreements are strictly governed by and construed in accordance with the exclusive jurisdiction of the state courts operating within <strong className="text-clothcare-primary font-bold decoration-2 underline-offset-4 underline">Ahmedabad, Gujarat, India.</strong>
                      </p>
                    </div>
                  </div>
                </div>
