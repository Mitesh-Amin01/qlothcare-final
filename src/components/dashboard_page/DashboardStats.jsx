    ...
    return (
        ...
        >
            <div className="bg-white rounded-4xl p-8 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="w-12 h-12 rounded-xl bg-clothcare-primary/10 text-text-accent flex items-center justify-center mb-6">
                    <Shirt size={24} />
                </div>
                <p className="text-text-muted text-sm font-medium mb-1">Items in Vault</p>
                <h3 className="text-4xl font-black text-text-dark">12</h3>
            </div>
            ...
            <div className="bg-white rounded-4xl p-8 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-text-muted text-sm font-medium mb-1">Active Deliveries</p>
                <h3 className="text-4xl font-black text-text-dark">1</h3>
            </div>

            <div className="bg-gray-900 rounded-[2rem] p-8 shadow-xl relative overflow-hidden text-text-primary flex flex-col justify-between group cursor-pointer hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
                <div className="absolute inset-0 bg-linear-to-br from-clothcare-primary/40 to-transparent opacity-50"></div>
                <div className="relative z-10">
                    <p className="text-text-primary/70 text-sm font-medium mb-2 uppercase tracking-widest">Premium Care</p>
                    <h3 className="text-3xl font-black leading-tight">Need urgent <br /> restoration?</h3>
                </div>
                <div className="relative z-10 flex items-center gap-3 mt-6 text-text-accent font-bold">
