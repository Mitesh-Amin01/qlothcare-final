        ...
        <div className="flex-1 overflow-y-auto px-10 pb-20">
            ...
            <div className="bg-white rounded-4xl p-8 border border-gray-100 shadow-sm space-y-8">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mb-6">Update your account details and preferences.</p>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" className="w-5 h-5 rounded text-clothcare-primary focus:ring-clothcare-primary border-gray-300" defaultChecked />
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" className="w-5 h-5 rounded text-clothcare-primary focus:ring-clothcare-primary border-gray-300" />
                ...
                <div className="pt-6">
                    <button className="bg-gray-900 text-white px-8 py-3.5 rounded-xl font-bold hover:bg-clothcare-primary transition-colors shadow-md">
                        Save Changes
                    </button>
                </div>
            </div>
