...
const AboutSection = () => {
  return (
    <motion.section
      ...
      className="relative py-32 bg-[#FAFAFA] font-sans overflow-hidden"
    >
      ...
      >
        <motion.h1
          ...
          className="text-[15rem] pl-5 font-bold text-[#0F172A] leading-none whitespace-nowrap"
        >
          About
        </motion.h1>
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <motion.div variants={item} className="flex items-center gap-3 mb-8">
              <span className="h-px w-12 bg-clothcare-primary" />
              <span className="text-[#0F172A] font-bold text-sm tracking-widest uppercase">
                Our Story
              </span>
            </motion.div>
            ...
            <motion.h2
              variants={item}
              className="text-4xl lg:text-5xl font-bold text-[#0F172A] leading-[1.1] mb-8"
            >
            ...
            {/* Body Copy */}
            <motion.div variants={item} className="space-y-6 text-lg text-[#64748B] leading-relaxed">
              <p>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#0F172A] rounded-full flex items-center justify-center text-white font-bold">
                  IP
                </div>
                <div>
                  <p className="text-[#0F172A] font-bold">Irfan Pathan</p>
          ...
          >
            <div className="grid grid-cols-2 gap-4 lg:gap-6">
              ...
              >
                ...
                <p className="text-white/60 text-sm">24/7 time for wash & fold orders.</p>
              </motion.div>
