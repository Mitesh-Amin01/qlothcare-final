...
export default function FranchiseTech() {
    ...
    return (
        <section className="bg-white py-40 relative z-10 overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10 max-w-7xl">
                <div className="text-center max-w-3xl mx-auto mb-24">
                    ...
                    <h2 className="text-5xl md:text-7xl font-black text-black leading-[1.1] tracking-tighter mb-8 font-display">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    {tools.map((tool, idx) => (
                        ...
                        >
                            <div className="w-24 h-24 rounded-[2rem] bg-gray-50 border border-gray-100 flex items-center justify-center text-gray-400 mb-10 group-hover:bg-clothcare-primary group-hover:text-white group-hover:-translate-y-2 transition-all duration-500 shadow-sm">
                                {tool.icon}
                            </div>
