...
export default function FranchisePartners() {
  ...
  return (
    <section className="bg-clothcare-black py-16 lg:py-24 border-b border-white/5 relative z-10">
      <div className="container mx-auto px-6 text-center">
        <p className="text-text-accent text-xs font-black uppercase tracking-[0.2em] mb-12">
        ...
        <div className="flex flex-wrap items-center justify-center gap-12 md:gap-32">
          {partners.map((partner, idx) => (
            <motion.div
              ...
              className="flex items-center justify-center gap-3 cursor-pointer text-text-primary"
            >
              <span className="text-text-accent">{partner.icon}</span>
